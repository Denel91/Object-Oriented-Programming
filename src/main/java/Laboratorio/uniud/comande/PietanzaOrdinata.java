...
/**
 * Rappresenta una pietanza nel momento in cui viene ordinata (e quindi possibilmente variata rispetto all'originale).
 */
public class PietanzaOrdinata extends Pietanza implements Variabile {
     ...
     * Costruttore (Creator).
     *
     * @param pietanza: pietanza di base. REQUIRE not null.
     */
     ...
     *
     * @param pietanzaOrdinata pietanza da cui ottenere i valori iniziali. REQUIRE not null.
     */
     ...
     *
     * @param valore stato di consegna della pietanza. REQUIRE not null.
     */
     ...
     */
    public boolean equals(PietanzaOrdinata altraPietanza) {
        return super.equals(altraPietanza) && variazioni.equals(altraPietanza);
    }
}
